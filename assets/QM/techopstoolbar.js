...
function createToolbar() {
	...
	toolbarTitleText = document.createTextNode('💀 TechOpsToolbar');
	toolbarTitle.appendChild(toolbarTitleText);
	toolbar.appendChild(toolbarTitle);

	// Backoffice links
	backofficeDropdown = createDrowndownMenu('Backoffice ▼', countries)
	...
	syncControlDropdown = createDrowndownMenu('Sync Control ▼', syncControlLinks)
	...
	syncMonitorDropdown = createDrowndownMenu('Sync Monitor ▼', syncMonitorLinks)
	toolbar.appendChild(syncMonitorDropdown);

    // Jira dropdown
	jiraDropdown = createDrowndownMenu('Jira ▼', jiraLinks)
	toolbar.appendChild(jiraDropdown);

    // Grafana dropdown
	grafanaDropdown = createDrowndownMenu('Grafana ▼', grafanaLinks)
	toolbar.appendChild(grafanaDropdown);

    // Donald dropdown
	donaldDropdown = createDrowndownMenu('Donald ▼', donaldLinks)
	...
	mappingTasksDropdownBtnText = document.createTextNode('Mapping Tasks ▼');
	...
	syncMonitorAddonsLink.innerHTML = 'Sync Monitor AddOns 🌟';
	if(syncMonitorAddonsEnabled) {
	    syncMonitorAddonsLink.className = 'addOnsEnabled';
	} else {
	    syncMonitorAddonsLink.className = 'addOnsDisabled';
